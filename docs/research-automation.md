...
| 3 | RA.2 | Frida attach-and-one-hook prototype | Event agrees with known GDB evidence; clean detach | Rejected on current stack: two pre-agent injection failures; reproduced bootstrap signal 11 followed by FM exit |
