...
| [05 — Tactic and XI selection](05-xi-optimisation/README.md) | Recommend a valid baseline tactic and lineup jointly | In progress | Joint role/player search works; full-catalogue bundle cost is an interactive bottleneck, now measured and attributed (upgrade plan §7.1) with mitigations not yet applied | 04 |
